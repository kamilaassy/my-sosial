...
describe('postLikes', () => {
  ...
  scenario('updates a postLike', async (scenario: StandardScenario) => {
    ...
    const result = await updatePostLike({
      id: original.id,
      input: { updatedAt: '2025-11-18T17:00:45.345Z' },
    })

    expect(result.updatedAt).toEqual(new Date('2025-11-18T17:00:45.345Z'))
  })
